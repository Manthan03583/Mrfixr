  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      ...
      slivers: [
                ...
                child: Row(
                  children: [
                    if (Get.find<SplashController>()
                        ...
                        1)
                      SizedBox(
                        width: providerController.providerList != null &&
                    ...
                    if (Get.find<SplashController>()
                        ...
                        providerController.providerList!.isNotEmpty)
                      const SizedBox(
                        width: Dimensions.paddingSizeLarge + 5,
                      ),
        ...
        //   child: Center(
        //     child: SizedBox(
        //         width: Dimensions.webMaxWidth, child: WebTrendingServiceView()),
        //   ),
        // ),
        const SliverToBoxAdapter(
          child: SizedBox(
