    ...
    return GetBuilder<ServiceController>(
      builder: (serviceController) {
        if (serviceController.recommendedServiceList != null &&
          ...
          if (serviceController.recommendedServiceList != null) {
            List<Service>? recommendedServiceList =
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: recommendedServiceList!.length > 2
                          ? 3
            ...
            return const WebCampaignShimmer(
              enabled: true,
            );
          }
        }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
                      ...
                      child: Container(
                        ...
                        child: Directionality(
                          ...
                          child: Text(
                            ...
                            style: ubuntuMedium.copyWith(color: Colors.purple),
                          ),
                        ),
                      ),
                    ),
        ...
        //     padding: const EdgeInsets.symmetric(
        //         horizontal: Dimensions.paddingSizeSmall,
        //         vertical: Dimensions.paddingSizeMini),
        //     child: Column(
        //         crossAxisAlignment: CrossAxisAlignment.start,
