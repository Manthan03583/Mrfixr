    ...
    return GetBuilder<ServiceController>(builder: (serviceController) {
      return SizedBox(
        height: Get.find<LocalizationController>().isLtr
            ? serviceController.categoryList.length * 315
            : serviceController.categoryList.length * 325,
        child: ListView.builder(
          itemBuilder: (context, categoryIndex) {
            int serviceItemCount;
            serviceItemCount = serviceController.categoryList[categoryIndex]
                        ...
                        SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: CustomImage(
                              fit: BoxFit.contain,
                              image:
                                  '${Get.find<SplashController>().configModel.content!.imageBaseUrl}/category/${serviceController.categoryList[categoryIndex].image}',
                              height:
                                  ResponsiveHelper.isWeb(context) ? 120 : 20,
                              width: ResponsiveHelper.isWeb(context) ? 40 : 20,
                            ),
                          ),
                        ),
                      if (ResponsiveHelper.isDesktop(context) ||
