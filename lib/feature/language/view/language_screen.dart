...
class _LanguageScreenState extends State<LanguageScreen> {
  ...
  void initState() {
    ...
    Get.find<LocalizationController>().setSelectIndex(
        Get.find<LocalizationController>().isLtr ? 0 : 1,
        shouldUpdate: false);
    super.initState();
  }
                    ...
                    child: SafeArea(
                      child: CustomButton(
                          onPressed: () {
                            ...
                            } else if (widget.fromPage == 'menuDrawer' ||
                                widget.fromPage == 'fromSettingsPage') {
