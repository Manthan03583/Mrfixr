...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ResponsiveHelper.isWeb(context)
          ? CustomAppBar(
              title: "${widget.name}\n+${widget.phone}",
            )
          : AppBar(
              ...
              title: Text(
                  "${widget.name}\n"
                  "${widget.userType == "provider" && Get.find<SplashController>().configModel.content?.phoneNumberVisibility == 0 ? "" : "+${widget.phone}"}",
        ...
        child: WebShadowWrap(
          child: GetBuilder<ConversationController>(initState: (state) {
            ...
            if (conversationController.conversationList != null) {
                      ...
                      child: conversationList.isNotEmpty
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                bool isRightMessage =
                                    conversationList.elementAt(index).userId ==
                                        customerID;
                                return ConversationBubble(
                                  conversationData:
                                      conversationList.elementAt(index),
                          ...
                          : SizedBox(
                              child:
                                  Center(child: Text('no_conversation_yet'.tr)),
                            ),
                    ),
                    Column(
                      children: [
                                  ...
                                  children: [
                                    Container(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 25),
                                        child: Center(
                                            child: Text(conversationController
                                                .otherFile!.names
                                                .elementAt(0)
                                                .toString()))),
                                    InkWell(
              ...
              return SizedBox(
                  height: ResponsiveHelper.isWeb(context) ? 500 : null,
