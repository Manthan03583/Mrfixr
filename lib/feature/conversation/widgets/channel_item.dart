...
class ChannelItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String imagePath = conversationUserModel.user!.userType == "customer"
        ? "/user/profile_image/"
        : conversationUserModel.user!.userType == "provider-admin"
            ? "/provider/logo/"
            : conversationUserModel.user!.userType == "super-admin"
                ? "/user/profile_image/"
                : conversationUserModel.user!.userType == "provider-serviceman"
                    ? "/serviceman/profile/"
                    : "";
    String name = '';
    String image = '';
    ...
    if (conversationUserModel.user!.provider != null) {
      ...
      image =
          ...
          '$imagePath${conversationUserModel.user!.provider!.logo!}';
      ...
      userTypeImage =
          conversationUserModel.user!.userType! == 'provider-serviceman'
              ? "provider-serviceman".tr
              : "super-admin".tr;
      userType = conversationUserModel.user!.userType! == 'provider-serviceman'
          ? "serviceman".tr
          : "admin".tr;
    }
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: CustomImage(height: 50, width: 50, image: image),
                    ),
