...
class _ConversationBubbleState extends State<ConversationBubble> {
  ...
  Widget build(BuildContext context) {
    String imagePath = widget.conversationData.user!.userType == "customer"
        ? "/user/profile_image/"
    ...
    if (widget.conversationData.user!.provider != null) {
      image =
          ...
          '$imagePath${widget.conversationData.user!.provider!.logo!}';
    } else {
      image =
          '${Get.find<SplashController>().configModel.content!.imageBaseUrl}'
          '$imagePath${widget.conversationData.user!.profileImage!}';
    }
                  ...
                  Flexible(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (widget
                            .conversationData.conversationFile!.isNotEmpty)
                        ...
                        widget.conversationData.conversationFile!.isNotEmpty
                            ? Directionality(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemCount: widget.conversationData
                                      .conversationFile!.length,
                                        ...
                                        ? InkWell(
                                            onTap: () => showDialog(
                                              ...
                                              builder: (ctx) => ImageDialog(
                                                  imageUrl:
                                                      '${Get.find<SplashController>().configModel.content!.imageBaseUrl}/conversation/${widget.conversationData.conversationFile![index].fileName ?? ''}'),
                                            ),
                                            child: ClipRRect(
                                              borderRadius:
