...
class WebLandingPage extends StatefulWidget {
  ...
  const WebLandingPage(
      {Key? key, required this.fromSignUp, required this.route})
      : super(key: key);
    ...
    return GetBuilder<WebLandingController>(
      builder: (webLandingController) {
        if (webLandingController.webLandingContent != null) {
          ...
          var imageContent = {
            for (var e in webLandingController.webLandingContent!.imageContent!)
              e.keyName: e.liveValues
          };
          print(
              'WebCHeck------------------------- ${webLandingController.webLandingContent!.imageContent!}');
          print(
              'WEBIMAGE-------------------- $baseUrl/storage/app/public/landing-page/web/${imageContent['download_section_image']}');
              ...
              child: Column(
                ...
                children: [
                  ...
                  _config.content!.providerSelfRegistration == '1'
                      ...
                      : const SizedBox(),
                  SizedBox(
                      height: _config.content!.providerSelfRegistration == '1'
                          ? 40
                          : 0),
                  SizedBox(
                    height: 570.0,
                      ...
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            //     // "$baseUrl/storage/app/public/landing-page/web/${imageContent['download_section_image']}",
                    ...
                    child: Stack(
                      ...
                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  if (textContent['web_bottom_title'] != null &&
                                    ...
                                    Text(
                                      textContent['web_bottom_title']!,
                                      style: ubuntuBold.copyWith(fontSize: 18),
                                    ),
                                  const SizedBox(
                        ...
                        Positioned(
                          ...
                          top: -65.0,
                          child: const CustomImage(
                            image: 'assets/images/person_clean.jpg',
                            // "$baseUrl/landing-page/web/${imageContent['support_section_image']}",
                            fit: BoxFit.cover,
