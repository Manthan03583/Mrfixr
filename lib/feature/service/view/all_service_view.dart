...
class AllServiceView extends StatefulWidget {
  ...
  const AllServiceView(
      {super.key, required this.fromPage, required this.campaignID});
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  PaginatedListView(
                    scrollController: scrollController,
                    totalSize: serviceController.trendingServiceContent != null
                        ? serviceController.trendingServiceContent!.total!
                        : null,
                    offset: serviceController.trendingServiceContent != null
                        ? serviceController
                                    .trendingServiceContent!.currentPage !=
                                null
                            ? serviceController
                                .trendingServiceContent!.currentPage!
                            : null
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  PaginatedListView(
                    scrollController: scrollController,
                    totalSize: serviceController.recentlyViewServiceContent !=
                            null
