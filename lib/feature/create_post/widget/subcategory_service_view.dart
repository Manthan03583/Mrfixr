...
class SubcategoryServiceView extends StatefulWidget {
  ...
  const SubcategoryServiceView({Key? key, required this.categoryId})
      : super(key: key);
  ...
  void initState() {
    ...
    Get.find<CategoryController>()
      ...
      Get.find<ServiceController>().getSubCategoryBasedServiceList(
          Get.find<CategoryController>().subCategoryList![0].id!, false,
  ...
  pointerInterceptor() {
    return Padding(
      padding: EdgeInsets.only(
          top: ResponsiveHelper.isWeb(context)
              ? 0
              : Dimensions.cartDialogPadding),
      child: PointerInterceptor(
                            ...
                            GetBuilder<ServiceController>(
                              ...
                              if (categoryController.subCategoryList != null &&
                                  serviceController
                                      ...
                                      null &&
                                  serviceController
                                      .subCategoryBasedServiceList!.isEmpty) {
                                return NoDataScreen(
                                                        ...
                                                        ClipRRect(
                                                            ...
                                                            child: CustomImage(
                                                                ...
                                                                fit: BoxFit
                                                                    .cover,
                                                                image:
                                                                    "${Get.find<SplashController>().configModel.content!.imageBaseUrl}/service/"
                                                                  ...
                                                                  discountModel
                                                                      ...
                                                                      ? Directionality(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            style:
                                                                                ubuntuMedium.copyWith(fontSize: Dimensions.paddingSizeDefault, color: Get.isDarkMode ? Theme.of(context).primaryColorLight : Theme.of(context).primaryColor),
                                                                          ),
                                                                        )
                                                                      : Directionality(
                                                                          textDirection:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            PriceConverter.convertPrice(lowestPrice.toDouble()),
                                                                            style:
                                                                                ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Get.isDarkMode ? Theme.of(context).primaryColorLight : Theme.of(context).primaryColor),
                                                                          ),
                                                                        ),
                                                                ],
                                                              ),
