  ...
  void initState() {
    ...
    if (widget.address != null) {
      ...
      _contactPersonNameController.text =
          widget.address?.contactPersonName?.replaceAll("null null", "") ?? "";
    ...
    if (widget.address == null) {
      _countryController.text = Get.find<SplashController>()
              .configModel
              .content
              ?.userLocationInfo
              ?.countryName ??
                          ...
                          if (locationController.zoneID.isEmpty) {
                            ...
                            AddressModel addressModel = AddressModel(
                              id: widget.address != null
                                  ...
                                  : null,
                              addressType:
                                  locationController.selectedAddressType.name,
                              addressLabel: locationController
                                  .selectedAddressLabel.name
                                  .toLowerCase(),
                              contactPersonName:
                                  _contactPersonNameController.text,
                              contactPersonNumber:
