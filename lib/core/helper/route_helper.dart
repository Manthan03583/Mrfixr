...
class RouteHelper {
  ...
  static String getInitialRoute({String fromPage = "home"}) =>
      '$initial?page=$fromPage';
  ...
  static String getPickMapRoute(
      String page, bool canRoute, String isFromCheckout) {
  ...
  static String getServiceRoute(String id, {String fromPage = "others"}) =>
      '$service?id=$id&fromPage=$fromPage';
  ...
  static String getOrderSuccessRoute(String status) =>
      '$orderSuccess?payment_status=$status';
  ...
  static String getCustomPostCheckoutRoute(
      String postId, String providerId, String amount) {
  ...
  static String getChatScreenRoute(String channelId, String name, String image,
      String phone, String bookingID, String userType) {
  ...
  static String getFeatheredCategoryService(
      String fromPage, CategoryData categoryData) {
    String data =
        base64Url.encode(utf8.encode(jsonEncode(categoryData.toJson())));
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          CategoryData categoryData =
              CategoryData.fromJson(jsonDecode(utf8.decode(decode)));
    ...
    GetPage(
        ...
        page: () => getRoute(OrderSuccessfulScreen(
              status:
                  Get.parameters['payment_status']!.contains('success') ? 1 : 0,
            ))),
    GetPage(
        ...
        page: () {
          ...
          if (Get.parameters['payment_status'] == 'failed' ||
              Get.parameters['payment_status'] == 'fail') {
            return getRoute(const OrderSuccessfulScreen(
              status: 0,
            ));
          }
          ...
          return getRoute(CheckoutScreen(
              Get.parameters.containsKey('payment_status') &&
                      Get.parameters['payment_status']! == 'success'
                  ? 'complete'
    ...
    GetPage(
        ...
        page: () {
          List<int> decode =
              base64Decode(Get.parameters['myPostData']!.replaceAll(' ', '+'));
          MyPostData data =
              MyPostData.fromJson(jsonDecode(utf8.decode(decode)));
  ...
  static getRoute(Widget navigateTo) {
    ...
    if (Get.find<SplashController>().configModel.content!.minimumVersion !=
        null) {
