...
class _ProductBottomSheetState extends State<ServiceCenterDialog> {
  ...
  void initState() {
    Get.find<CartController>()
        .getProviderBasedOnSubcategory(widget.service!.subCategoryId!, true);
                                                                  ...
                                                                  Directionality(
                                                                    ...
                                                                    child: Text(
                                                                        PriceConverter.convertPrice(
                                                                            double.parse(cartControllerInit.initialCartList[index].price
                                                                                .toString()),
                                                                            isShowLongPrice:
                                                                                true),
                                                                        style: ubuntuMedium.copyWith(
                    ...
                    Positioned(
                        ...
                        child: GetBuilder<CartController>(
                          ...
                          return cartController.isLoading
                              ...
                              : Row(children: [
                                  //------------------UNSELECTEDPRODUCTWIDGET [LOGO AT "ADD TO CART"]--------------------
