...
class AppConstants {
  static const String appName = 'Mr.Fixr';
  static const String appVersion = '2.0';
  //https://demandium-admin.6amtech.com
  //https://admin.mrfixr.f2fdigital.in
  //
  // Google Map API key
  //static const String mapApiKey = 'AIzaSyCQ2PplFk6A16QPzWAngh2r3BFUeXckadY';
  //http://mrfixer.f2fdigital.in/main?page=home
  static const String baseUrl = 'https://mrfixr.edevlop.com';
