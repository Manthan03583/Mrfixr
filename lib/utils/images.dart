class Images {
  static String get logo => 'splashlogo'.png;
  static String get splashscreendown => 'splashscreendown'.png;
  static String get rench => 'rench'.png;
  static String get drillMachine => 'drillmachine'.png;
  static String get paintBrush => 'paint_brush'.png;
  // static String get beautyProduct => 'beauty_product'.png;
  static String get vaccum => 'vaccum_remover'.png;
  static String get appbarLogo => 'assets/icon/icon.png';
  ...
  static String get od => 'od'.png;
  static String get hi => 'hi'.png;
  //
